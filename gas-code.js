...
var SHEETS={'학생등록':'학생목록','학생목록':'학생목록','신앙온도':'신앙온도','신앙일기':'신앙일기','공감QT':'공감QT','삼줄기도':'삼줄기도','적용점':'적용점','QT':'QT','기도제목':'기도제목','메시지':'메시지'};
var HEADERS={
...
switch(type){
  ...
  case '적용점':upsertRow(sn,data,h,['학생id','적용점내용']);break;
